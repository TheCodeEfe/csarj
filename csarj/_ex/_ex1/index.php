      ...
      <div class="col-lg-12 col-12">
        <form action="">
          <div class="form__title">
            <h1>Formu doldur,  hemen oyuna katıl!</h1>
            <p>Tüm Türkiye'ye hizmet vermemizi büyük çekiliş kampanyasıyla hep beraber kutluyoruz. </br>
              Sen de hemen formu doldurarak sorulara cevaplar verip kolayca çekilişe katılabilirsin.</p>
          </div>
            ...
            <div class="form__content-bg">
              <div class="form__content-bg-text">
                <div class="form__content-bg-text-box">
                  ...
                  <span><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Veri paylaşım iznini</a> okudum onaylıyorum.</span>
                </div>
                <div class="form__content-bg-text-box">
                  <input type="checkbox" name="a">
                  <span><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Kullanım koşullarını</a> okudum onaylıyorum.</span>
                </div>
                <!-- Modal -->
                  ...
                  <div class="modal-dialog modal-ku">
                    <div class="modal-content">
                      <div class="modal-title text-center">
                        <h5 class="modal-title text-center" id="exampleModalLabel">Veri Paylaşım İzni</h5>
                      </div>
