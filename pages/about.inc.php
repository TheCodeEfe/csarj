        ...
        <div class="container">
            <div class="title-page--bg"> 
                ...
                <div class="title-page--title">
                    <h1>Hakkımızda</h1>
                    <p>C-Şarj, çevresel sürdürülebilirlik prensibiyle güzel bir gelecek inşa etmek amacıyla kurulan, yeni nesil elektrikli araç şarj istasyonudur. </p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="main-bg">
                ...
                <div class="main-bg--title">
                    ...
                    <p class="main-bg--dic">C-Şarj olarak, Türkiye’de dört farklı kolda enerji dolu hizmetler sunuyoruz.</br>
                        ...
                        Geleceğimizi güzelleştirmek için harekete geçtiğimiz bu yolda hem size hem de doğal çevremize çok iyi geleceğiz.</p>
                </div>
            </div>
        </div>
    </section>
